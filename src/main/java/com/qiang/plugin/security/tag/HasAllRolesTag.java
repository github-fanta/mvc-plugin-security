package com.qiang.plugin.security.tag;
...
public class HasAllRolesTag extends RoleTag{
    ...
    private static final String ROLE_NAMES_DILIMITER=",";
    ...
    protected boolean showTagBody(String roleNames) {
        ...
        if (subject != null){
            if (subject.hasAllRoles(Arrays.asList(roleNames.split(ROLE_NAMES_DILIMITER)))){
                hasAllRole = true;
            }
        }
        return hasAllRole;
